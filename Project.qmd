...
Now, I am going to compare it with a majority of the variables that are in the data set to see if that would change anything. I did exclude some variables as they are highly correlated with another variable. 

```{r}
#| label: more variables k-means

cluster_data_new <- teams |>
  select(
    AVG, HR, SB, BB, ERA, WHIP, SV, E, DP, run_diff) |>
  na.omit()
